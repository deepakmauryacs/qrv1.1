...
@section('pageTitle', 'Customer Invoice')
@section('content')

<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="h3 text-gray-800">Customer Invoice</h1>
        <!-- Add Button to trigger modal -->
        <a  href="{{ route('vendor.invoice.create') }}" type="button" class="btn btn-primary">
...
<script>
    ...
    $(document).ready(function() {
        $('#dataTable').DataTable({
            ...
            searching: false,
            pageLength: 25,
            ajax: '{{ route('vendor.invoice.list') }}', // Your AJAX route
            columns: [
