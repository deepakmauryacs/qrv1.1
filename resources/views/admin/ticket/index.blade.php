                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <select id="ticket-status-field" class="form-control">
                            <option value="1">Ticket Generated</option>
                            <option value="2">Ticket Resolving</option>
...
<script>
    ...
    $(document).ready(function() {
        $('#dataTable').DataTable({
            ...
            searching: false,
            pageLength: 25,
            ajax: '{{ route('admin.tickets.list') }}', // Your AJAX route
            columns: [
        ...
        $('#update-ticket-status').click(function(e) {
            ...
            if (id) {
                ...
                $.ajax({
                    url: "{{ route('admin.tickets.update-status') }}",
                    type: 'POST',
                    data: {
                        id: id,
                        status: status,
