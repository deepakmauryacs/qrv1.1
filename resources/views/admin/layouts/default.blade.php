...
<head>
    ...
    <title>Digital QR - Admin Dashboard</title>
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="{{ route('admin.menus') }}">Menu</a>
                        <a class="collapse-item" href="{{ route('admin.menu-categories') }}">Menu Category</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">vendor module:</h6>
                        <a class="collapse-item" href="{{ route('admin.vendors') }}">Vendor module</a>
                        <a class="collapse-item" href="{{ route('admin.subscriptions') }}">Subscriptions module</a>
                    </div>
                </div>
            </li>
            <li class="nav-item active">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="{{ route('admin.menu-request.index') }}">
                    <i class="bi bi-speedometer2"></i>
            ...
            <div class="sidebar-card d-none d-lg-flex">
                <a  href="{{ route('admin.logout') }}"><i class="bi bi-lock"></i>Logout</a>
            </div>
